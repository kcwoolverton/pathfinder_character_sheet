...
def make_mod_text(mods):  #4 (line in Coconut source)
# type: (...) -> str
...
def roll_dice(rng, die_type, num_dice, num_rolls):  #14 (line in Coconut source)
# type: (...) -> list[int]
...
def make_roll_result_text(rolls,  # type: list[int]  #23 (line in Coconut source)
    modifiers  # type: list[int]  #23 (line in Coconut source)
...
def get_attack_info(attack_info_str  # type: str  #34 (line in Coconut source)
    ):  #34 (line in Coconut source)
# type: (...) -> (_coconut.typing.Tuple[str, str, int])
