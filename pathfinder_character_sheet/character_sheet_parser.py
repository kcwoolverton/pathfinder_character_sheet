...
def create_spell_from_node(spell_node,  # type: ET.Element  #148 (line in Coconut source)
    **kwargs):  #148 (line in Coconut source)
# type: (...) -> Spell
...
def parse_spells(root  # type: ET.Element  #170 (line in Coconut source)
...
def parse_feats(root  # type: ET.Element  #182 (line in Coconut source)
...
def parse_resistances(root  # type: ET.Element  #199 (line in Coconut source)
...
def parse_special_qualities(root  # type: ET.Element  #205 (line in Coconut source)
...
def parse_weapon_proficiences(root  # type: ET.Element  #235 (line in Coconut source)
    ):  #235 (line in Coconut source)
# type: (...) -> str
    return root.find("weapon_proficiencies").text  #236 (line in Coconut source)


def parse_xml(input_file):  #238 (line in Coconut source)
# type: (...) -> Character
